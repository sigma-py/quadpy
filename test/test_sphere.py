...
@pytest.mark.parametrize(
    ...
    + [
        ...
        (quadpy.sphere.heo_xu_17(), 1.0e-13),
        (quadpy.sphere.heo_xu_19_1(), 1.0e-13),
        (quadpy.sphere.heo_xu_19_2(), 1.0e-12),
        (quadpy.sphere.heo_xu_21_1(), 1.0e-9),
        (quadpy.sphere.heo_xu_21_2(), 1.0e-9),
        (quadpy.sphere.heo_xu_21_3(), 1.0e-9),
        (quadpy.sphere.heo_xu_21_4(), 1.0e-9),
        (quadpy.sphere.heo_xu_21_5(), 1.0e-9),
        (quadpy.sphere.heo_xu_21_6(), 1.0e-9),
        (quadpy.sphere.heo_xu_23_1(), 1.0e-9),
        (quadpy.sphere.heo_xu_23_2(), 1.0e-9),
        (quadpy.sphere.heo_xu_23_3(), 1.0e-9),
        (quadpy.sphere.heo_xu_25_1(), 1.0e-9),
        (quadpy.sphere.heo_xu_25_2(), 1.0e-9),
        (quadpy.sphere.heo_xu_27_1(), 1.0e-9),
        (quadpy.sphere.heo_xu_27_2(), 1.0e-9),
        (quadpy.sphere.heo_xu_27_3(), 1.0e-9),
        (quadpy.sphere.heo_xu_29(), 1.0e-9),
        (quadpy.sphere.heo_xu_31(), 1.0e-9),
        (quadpy.sphere.heo_xu_33(), 1.0e-9),
        (quadpy.sphere.heo_xu_35(), 1.0e-8),
        (quadpy.sphere.heo_xu_37(), 1.0e-9),
        (quadpy.sphere.heo_xu_39_1(), 1.0e-6),
        (quadpy.sphere.heo_xu_39_2(), 1.0e-8),
    ]
    + [
