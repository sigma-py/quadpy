...
@pytest.mark.parametrize(
    'scheme',
    [quadpy.nsphere.Dobrodeev1978(n, symbolic=False) for n in range(2, 7)]
    + [quadpy.nsphere.Stroud(n, index, symbolic=False) for n in range(2, 7)
        for index in [
        'Un 3-1', 'Un 3-2',
    ...
    + [quadpy.nsphere.Stroud(n, index, symbolic=False) for n in range(3, 6)
        for index in [
        'Un 11-1',
        ]]
    + [quadpy.nsphere.Stroud1967(n, symbolic=False) for n in range(2, 7)]
    )
