...
class Gatermann(object):
    ...
    def __init__(self):
        ...
        self.degree = 5
        data = [
            (9.73033316198362119165356216965707e-06, _s31(0.656936552995394536166881327385593)),
            (8.99031481668747219698547129902142e-03, _s31(0.0801424420792727848879183805550907)),
            (2.17777476778781405656596945369837e-02, _s22(0.404475329343454044779549906725159)),
            ]
