    ...
    def __init__(self, index):
        if index == 1:
            self.weights = numpy.concatenate([
                numpy.full(4, 0.0063971477799023213214514203351730),
                numpy.full(4, 0.0401904480209661724881611584798178),
                numpy.full(4, 0.0243079755047703211748691087719226),
                numpy.full(4, 0.0548588924136974404669241239903914),
                numpy.full(6, 0.0357196122340991824649509689966176),
                numpy.full(12, 0.0071831906978525394094511052198038),
                numpy.full(12, 0.0163721819453191175409381397561191),
                ])
            ...
            assert index == 2
            self.weights = numpy.concatenate([
                numpy.full(4, .0040651136652707670436208836835636),
                numpy.full(4, .0022145385334455781437599569500071),
                numpy.full(4, .0058134382678884505495373338821455),
                numpy.full(4, .0196255433858357215975623333961715),
                numpy.full(4, .0003875737905908214364538721248394),
                numpy.full(12, .0116429719721770369855213401005552),
                numpy.full(12, .0052890429882817131317736883052856),
                numpy.full(12, .0018310854163600559376697823488069),
                numpy.full(12, .0082496473772146452067449669173660),
                numpy.full(24, .0030099245347082451376888748208987),
                numpy.full(24, .0008047165617367534636261808760312),
                numpy.full(24, .0029850412588493071187655692883922),
                numpy.full(24, .0056896002418760766963361477811973),
                numpy.full(24, .0041590865878545715670013980182613),
                numpy.full(24, .0007282389204572724356136429745654),
                numpy.full(24, .0054326500769958248216242340651926),
                ])
            bary = numpy.concatenate([
