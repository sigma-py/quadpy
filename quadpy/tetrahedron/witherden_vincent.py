...
class WitherdenVincent(object):
    ...
    def __init__(self, degree):
        ...
        if degree == 1:
            data = [
                (1.000000000000000e+00, _s4()),
                ]
        elif degree == 2:
            data = [
                (2.500000000000000e-01, _s31(1.381966011250105e-01)),
                ]
        elif degree == 3:
            data = [
            ...
            data = [
                ...
                (4.821428571428571e-02, _s211(6.366100187501744e-02, 6.030056647916492e-01)),
                ]
        elif degree == 7:
            data = [
                ...
                (3.720713072833462e-02, _s211(1.888338310260010e-01, 5.751716375870000e-01)),
                (8.110770829903342e-03, _s211(2.126547254148314e-02, 8.108302410985486e-01)),
                ]
        elif degree == 8:
            data = [
                ...
                (7.156902890844433e-03, _s211(2.143393012713057e-02, 7.174640634263083e-01)),
                (1.545348615096034e-02, _s211(2.041393338760291e-01, 5.837973783021444e-01)),
                ]
        elif degree == 9:
            data = [
                ...
                (8.384422198298552e-03, _s211(4.588714487524592e-01, 2.554579233041310e-03)),
                (1.023455935274533e-02, _s211(3.377587068533860e-02, 7.183503264420745e-01)),
                (2.052491596798814e-02, _s211(1.836413698099279e-01, 3.441591057817528e-02)),
                ]
        else:
            assert degree == 10
            data = [
                ...
                (1.139388122019523e-02, _s211(4.104307392189654e-01, 1.654860256196111e-01)),
                (3.619443443392536e-04, _s211(6.138008824790653e-03, 9.429887673452049e-01)),
                (2.573973198045607e-02, _s211(1.210501811455894e-01, 4.771903799042804e-01)),
                (1.013587167975579e-02, _s211(3.277946821644262e-02, 5.942562694800070e-01)),
                (6.576147277035904e-03, _s211(3.248528156482305e-02, 8.011772846583444e-01)),
                (1.290703579886199e-02, _s211(1.749793421839390e-01, 6.280718454753660e-01)),
                ]
