...
class WilliamsShunnJameson(object):
    ...
    def __init__(self):
        self.degree = 9
        data = [
            (0.002144935144316, _s31(0.026878474414817)),
            (0.020826641690769, _s31(0.187140675803470)),
            (0.007210136064455, _s22(0.473575835127937)),
            (0.030798919159712, _s22(0.352045262027356)),
            (0.004357844813864, _s211(0.020953442220056, 0.225783205866940)),
