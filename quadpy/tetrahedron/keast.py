    ...
    def __init__(self, index):
        if index == 0:
            ...
            data = [
                ...
                (0.0214899534130631, _s22(fr(1, 2))),
                ]
        elif index == 4:
            self.degree = 4
            data = [
                (-fr(148, 1875), _s4()),
                (+fr(343, 7500), _s31(fr(1, 14))),
                (+fr(56, 375), _s22(0.3994035761667992)),
                ]
        elif index == 5:
            self.degree = 4
            data = [
                (fr(2, 105), _s22(fr(1, 2))),
            ...
            data = [
                (fr(6544, 36015), _s4()),
                (fr(81, 2240), _s31(fr(1, 3))),
                (fr(161051, 2304960), _s31(fr(1, 11))),
                (fr(338, 5145), _s22(0.0665501535736643)),
                ]
        elif index == 7:
            self.degree = 6
            data = [
                ...
                (fr(27, 560), _s211(0.0636610018750175, 0.2696723314583159)),
                ]
        elif index == 8:
            self.degree = 7
            data = [
                ...
                (+0.0058201058201058, _s22(fr(1, 2))),
                (+0.1653439153439105, _s211(fr(1, 10), fr(1, 5))),
                ]
        elif index == 9:
            self.degree = 8
            data = [
