...
def rabinowitz_richter_2():
    ...
    points, weights = untangle(data)
    weights /= pi
    return E2r2Scheme("Rabinowitz-Richter 2", weights, points, 11, _source)
...
def rabinowitz_richter_3():
    ...
    points, weights = untangle(data)
    weights /= pi
    return E2r2Scheme("Rabinowitz-Richter 3", weights, points, 11, _source)
...
def rabinowitz_richter_4():
    ...
    points, weights = untangle(data)
    weights /= pi
    return E2r2Scheme("Rabinowitz-Richter 4", weights, points, 13, _source)
...
def rabinowitz_richter_5():
    ...
    points, weights = untangle(data)
    weights /= pi
    return E2r2Scheme("Rabinowitz-Richter 5", weights, points, 15, _source)
