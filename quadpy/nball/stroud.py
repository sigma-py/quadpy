...
class Stroud(object):
    ...
    def __init__(self, n, index, symbolic=False):
        ...
        if index == "Sn 2-1":
            ...
            self.set_data(
                hammer_stroud.HammerStroud(n, "11-n", alpha=0, symbolic=symbolic)
            )
        elif index == "Sn 3-2":
            self.degree = 3
            ...
            self.set_data(
                hammer_stroud.HammerStroud(n, "12-n", alpha=0, symbolic=symbolic)
            )
        elif index == "Sn 5-3":
            self.set_data(stroud1966.Stroud1966(n, variant="a", symbolic=symbolic))
        elif index == "Sn 5-4":
            self.set_data(stroud1966.Stroud1966(n, variant="b", symbolic=symbolic))
        elif index == "Sn 5-5":
            self.set_data(stroud1966.Stroud1966(n, variant="c", symbolic=symbolic))
        elif index == "Sn 5-6":
            self.set_data(stroud1966.Stroud1966(n, variant="d", symbolic=symbolic))
        elif index == "Sn 7-1a":
            self.set_data(stroud1967b.Stroud1967b(n, variant="a", symbolic=symbolic))
        elif index == "Sn 7-1b":
            self.set_data(stroud1967b.Stroud1967b(n, variant="b", symbolic=symbolic))
        elif index == "Sn 7-2":
            self.set_data(stroud1967b.Stroud1967b(n, variant="c", symbolic=symbolic))
        elif index == "Sn 7-3a":
