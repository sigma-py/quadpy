...
class WitherdenVincent(object):
    ...
    def __init__(self, degree, symbolic=False):
        ...
        self.degree = degree
        if degree == 1:
            data = [(1.000000000000000e+00, _s3(symbolic))]
        elif degree == 2:
            data = [(3.333333333333333e-01, _s21(1.666666666666667e-01))]
        elif degree == 4:
            data = [
            ...
            data = [
                ...
                (
                    8.285107561837357e-02,
                    _s111(6.365024991213987e-01, 3.103524510337844e-01),
                ),
            ]
        elif degree == 7:
            data = [
            ...
            data = [
                ...
                (
                    1.167262118157585e-02,
                    _s111(8.132926410494192e-01, 1.680686452224144e-01),
                ),
                (
                    3.131547628496929e-02,
                    _s111(5.652526648771142e-01, 3.389506114752772e-01),
                ),
            ]
        elif degree == 16:
            data = [
                ...
                (
                    1.893827246441570e-02,
                    _s111(7.541700614447677e-01, 1.910747636405292e-01),
                ),
                (
                    1.654466714835048e-03,
                    _s111(9.682443680309587e-01, 2.320342776881373e-02),
                ),
                (
                    1.500860178428581e-02,
                    _s111(6.493036982454464e-01, 3.317645234741476e-01),
                ),
                (
                    7.947593933392498e-03,
                    _s111(9.002737032704295e-01, 8.069616698587301e-02),
                ),
                (
            ...
            data = [
                ...
                (
                    8.455887499536496e-03,
                    _s111(7.431813689574364e-01, 2.418945789605796e-01),
                ),
                (
                    3.327201362859388e-03,
                    _s111(9.301376988768051e-01, 6.008627532230670e-02),
                ),
            ]
        else:
            assert degree == 20
            data = [
                ...
                (
                    4.405794837116995e-03,
                    _s111(8.332955118382362e-01, 1.591337076570672e-01),
                ),
                (
                    1.197279715790938e-02,
                    _s111(7.549215028635474e-01, 1.985181322287883e-01),
                ),
                (
                    2.259739204251731e-03,
                    _s111(9.310544767839422e-01, 6.409058560843406e-02),
                ),
                (
