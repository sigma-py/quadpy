...
Abstract:
In this paper we develop some tools based on the theory of moments to be used to
construct triangur symmetric quadrature rules for the triangle. We use this technique to
construct rules of polynomial degree 13 focusing on rules that have all evaluation
points inside the triangle, and all weights positive.
"""
...
def berntsen_espelid_1(mpmath=False):
    ...
    # Algorithm 706: DCUTRI: An Algorithm for Adaptive Cubature over a Collection of
    # Triangles,
...
BerntsenEspelid = {
    1: berntsen_espelid_1,
    2: berntsen_espelid_2,
    3: berntsen_espelid_3,
    4: berntsen_espelid_4,
}
