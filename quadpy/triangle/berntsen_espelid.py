    ...
    def __init__(self, index):
        ...
        if index == 1:
            ...
            self.weights = numpy.concatenate([
                numpy.full(1, 0.051739766065744133555179145422),
                numpy.full(3, 0.008007799555564801597804123460),
                numpy.full(3, 0.046868898981821644823226732071),
                numpy.full(3, 0.046590940183976487960361770070),
                numpy.full(3, 0.031016943313796381407646220131),
                numpy.full(3, 0.010791612736631273623178240136),
                numpy.full(3, 0.032195534242431618819414482205),
                numpy.full(6, 0.015445834210701583817692900053),
            ...
            self.weights = numpy.concatenate([
                numpy.full(1, 0.058696079612719031799193912788),
                numpy.full(3, 0.007850768296100080327451819370),
                numpy.full(3, 0.050668953175886963421095258589),
                numpy.full(3, 0.050080326090509066160747699962),
                numpy.full(3, 0.031647114592298319035326893473),
                numpy.full(3, 0.005356903791090860889118181848),
                numpy.full(3, 0.031492563075968795690055730726),
                numpy.full(6, 0.015802532215260751359123743555),
            ...
            self.weights = numpy.concatenate([
                numpy.full(3, -4.438917939249711e-15),
                numpy.full(3, 0.023875084055169335843543623613),
                numpy.full(3, 0.063189783598782833129430995388),
                numpy.full(3, 0.008045069816524589599830031859),
                numpy.full(3, 0.027856097113552204952023523591),
                numpy.full(3, 0.050685061067025767745642589150),
                numpy.full(6, 0.014867088321983380610493967543),
            ...
            assert index == 4
            self.weights = numpy.concatenate([
                numpy.full(1, 0.055141401445961668095892272765),
                numpy.full(3, 0.000011142520455322162070507537),
                numpy.full(3, 0.008019330681470505488363363198),
                numpy.full(3, 0.033429216779221783453803543232),
                numpy.full(3, 0.046966588930899169431852266167),
                numpy.full(3, 0.031079169485602998741093672276),
                numpy.full(3, 0.048947942555161210000640851464),
                numpy.full(3, 0.005884459601338707440236321752),
                numpy.full(6, 0.015445834210701583817692900053),
                numpy.full(6, 0.017822989923178661888748319485),
                numpy.full(6, 0.037038683681384627918546472190),
                ])
