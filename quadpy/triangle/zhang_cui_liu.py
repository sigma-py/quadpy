        ...
        if index == 1:
            ...
            data = [
                ...
                (
                    ...
                    _s21(flt("0.1705693077517602066222935014914645")),
                ),
                (
                    flt("0.0324584976231980803109259283417806"),
                    _s21(flt("0.0505472283170309754584235505965989")),
                ),
                (
                    flt("0.0950916342672846247938961043885843"),
                    _s21(flt("0.4592925882927231560288155144941693")),
                ),
                (
            ...
            data = [
                ...
                (
                    ...
                    _s21(flt("0.0099797608064584324152935295820524")),
                ),
                (
                    flt("0.0261637825586145217778288591819783"),
                    _s21(flt("0.4799778935211883898105528650883899")),
                ),
                (
                    flt("0.0039197292424018290965208275701454"),
                    _s21(flt("0.1538119591769669000000000000000000")),
                ),
                (
                    flt("0.0122473597569408660972869899262505"),
                    _s21(flt("0.0740234771169878100000000000000000")),
                ),
                (
                    flt("0.0281996285032579601073663071515657"),
                    _s21(flt("0.1303546825033300000000000000000000")),
                ),
                (
                    flt("0.0508870871859594852960348275454540"),
                    _s21(flt("0.2306172260266531342996053700983831")),
                ),
                (
                    flt("0.0504534399016035991910208971341189"),
                    _s21(flt("0.4223320834191478241144087137913939")),
                ),
                (
            ...
            data = [
                ...
                (
                    ...
                    _s21(flt("0.2158743059329919731902545438401828")),
                ),
                (
                    flt("0.0097652722770514230413646914294237"),
                    _s21(flt("0.0753767665297472780972854309459163")),
                ),
                (
                    flt("0.0013984195353918235239233631597867"),
                    _s21(flt("0.0103008281372217921136862160096969")),
                ),
                (
                    flt("0.0092921026251851826304282034030330"),
                    _s21(flt("0.4936022112987001655119208321450536")),
                ),
                (
                    flt("0.0165778760323669253260236250351840"),
                    _s21(flt("0.4615509381069252967410487102915180")),
                ),
                (
