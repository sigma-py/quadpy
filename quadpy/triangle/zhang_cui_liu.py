...
Abstract:
We present a program for computing symmetric quadrature rules on triangles and
tetrahedra. A set of rules are obtained by using this program. Quadrature rules up to
order 21 on triangles and up to order 14 on tetrahedra have been obtained which are
useful for use in finite element computations. All rules presented here have positive
weights with points lying within the integration domain.
"""
from mpmath import mp

from .helpers import TriangleScheme, concat, s3, s2, s1
...
def zhang_cui_liu_1(mpmath=False):
    ...
    return TriangleScheme("Zhang-Cui-Liu 1", 8, weights, bary)
...
def zhang_cui_liu_2(mpmath=False):
    ...
    return TriangleScheme("Zhang-Cui-Liu 2", 14, weights, bary)
...
def zhang_cui_liu_3(mpmath=False):
    ...
    return TriangleScheme("Zhang-Cui-Liu 3", 20, weights, bary)


ZhangCuiLiu = {1: zhang_cui_liu_1, 2: zhang_cui_liu_2, 3: zhang_cui_liu_3}
