...
def strang_fix_cowper_01(symbolic=False):
    ...
    return TriangleScheme("Strang 1", weights, bary, 2, citation)
...
def strang_fix_cowper_02(symbolic=False):
    ...
    return TriangleScheme("Strang 2", weights, bary, 2, citation)
...
def strang_fix_cowper_03(symbolic=False):
    ...
    return TriangleScheme("Strang 3", weights, bary, 3, citation)
...
def strang_fix_cowper_04(symbolic=False):
    ...
    return TriangleScheme("Strang 4", weights, bary, 3, citation)
...
def strang_fix_cowper_05():
    ...
    return TriangleScheme("Strang 5", weights, bary, 4, citation)
...
def strang_fix_cowper_06(symbolic=False):
    ...
    return TriangleScheme("Strang 6", weights, bary, 4, citation)
...
def strang_fix_cowper_07(symbolic=False):
    ...
    return TriangleScheme("Strang 7", weights, bary, 5, citation)
...
def strang_fix_cowper_08(symbolic=False):
    ...
    return TriangleScheme("Strang 8", weights, bary, 5, citation)
...
def strang_fix_cowper_09(symbolic=False):
    ...
    return TriangleScheme("Strang 9", weights, bary, 6, citation)
...
def strang_fix_cowper_10():
    ...
    return TriangleScheme("Strang 10", weights, bary, 7, citation)
