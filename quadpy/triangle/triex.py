...
"""
from .helpers import concat, s1, s2, s3, TriangleScheme
...
def triex_19():
    ...
    return TriangleScheme("TRIEX 19", 9, weights, bary)
...
def triex_28():
    ...
    return TriangleScheme("TRIEX 28", 11, weights, bary)


Triex = {19: triex_19, 28: triex_28}
