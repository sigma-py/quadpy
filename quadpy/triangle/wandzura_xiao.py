    ...
    def __init__(self, index):
        ...
        if index == 1:
            self.weights = numpy.concatenate([
                numpy.full(1, 0.2250000000000000E+00),
            ...
            self.weights = numpy.concatenate([
                numpy.full(1, 0.8352339980519638E-01),
                numpy.full(3, 0.7229850592056743E-02),
                numpy.full(3, 0.7449217792098051E-01),
                numpy.full(3, 0.7864647340310853E-01),
                numpy.full(3, 0.6928323087107504E-02),
            ...
            self.weights = numpy.concatenate([
                numpy.full(3, 0.3266181884880529E-01),
                numpy.full(3, 0.2741281803136436E-01),
                numpy.full(3, 0.2651003659870330E-01),
                numpy.full(3, 0.2921596213648611E-01),
                numpy.full(3, 0.1058460806624399E-01),
                numpy.full(3, 0.3614643064092035E-02),
                numpy.full(6, 0.8527748101709436E-02),
                numpy.full(6, 0.1391617651669193E-01),
                numpy.full(6, 0.4291932940734835E-02),
                numpy.full(6, 0.1623532928177489E-01),
            ...
            self.weights = numpy.concatenate([
                numpy.full(1, 0.2761042699769952E-01),
                numpy.full(3, 0.1779029547326740E-02),
                numpy.full(3, 0.2011239811396117E-01),
                numpy.full(3, 0.2681784725933157E-01),
                numpy.full(3, 0.2452313380150201E-01),
                numpy.full(3, 0.1639457841069539E-01),
                numpy.full(3, 0.1479590739864960E-01),
                numpy.full(3, 0.4579282277704251E-02),
                numpy.full(3, 0.1651826515576217E-02),
                numpy.full(6, 0.2349170908575584E-02),
                numpy.full(6, 0.4465925754181793E-02),
                numpy.full(6, 0.6099566807907972E-02),
                numpy.full(6, 0.6891081327188203E-02),
                numpy.full(6, 0.7997475072478163E-02),
                numpy.full(6, 0.7386134285336024E-02),
                numpy.full(6, 0.1279933187864826E-01),
                numpy.full(6, 0.1725807117569655E-01),
            ...
            self.weights = numpy.concatenate([
                numpy.full(3, 0.8005581880020417E-02),
                numpy.full(3, 0.1594707683239050E-01),
                numpy.full(3, 0.1310914123079553E-01),
                numpy.full(3, 0.1958300096563562E-01),
                numpy.full(3, 0.1647088544153727E-01),
                numpy.full(3, 0.8547279074092100E-02),
                numpy.full(3, 0.8161885857226492E-02),
                numpy.full(3, 0.6121146539983779E-02),
                numpy.full(3, 0.2908498264936665E-02),
                numpy.full(3, 0.6922752456619963E-03),
                numpy.full(6, 0.1248289199277397E-02),
                numpy.full(6, 0.3404752908803022E-02),
                numpy.full(6, 0.3359654326064051E-02),
                numpy.full(6, 0.1716156539496754E-02),
                numpy.full(6, 0.1480856316715606E-02),
                numpy.full(6, 0.3511312610728685E-02),
                numpy.full(6, 0.7393550149706484E-02),
                numpy.full(6, 0.7983087477376558E-02),
                numpy.full(6, 0.4355962613158041E-02),
                numpy.full(6, 0.7365056701417832E-02),
                numpy.full(6, 0.1096357284641955E-01),
                numpy.full(6, 0.1174996174354112E-01),
                numpy.full(6, 0.1001560071379857E-01),
                numpy.full(6, 0.1330964078762868E-01),
            ...
            assert index == 6
            self.weights = numpy.concatenate([
                numpy.full(1, 0.1557996020289920E-01),
                numpy.full(3, 0.3177233700534134E-02),
                numpy.full(3, 0.1048342663573077E-01),
                numpy.full(3, 0.1320945957774363E-01),
                numpy.full(3, 0.1497500696627150E-01),
                numpy.full(3, 0.1498790444338419E-01),
                numpy.full(3, 0.1333886474102166E-01),
                numpy.full(3, 0.1088917111390201E-01),
                numpy.full(3, 0.8189440660893461E-02),
                numpy.full(3, 0.5575387588607785E-02),
                numpy.full(3, 0.3191216473411976E-02),
                numpy.full(3, 0.1296715144327045E-02),
                numpy.full(3, 0.2982628261349172E-03),
                numpy.full(6, 0.9989056850788964E-03),
                numpy.full(6, 0.4628508491732533E-03),
                numpy.full(6, 0.1234451336382413E-02),
                numpy.full(6, 0.5707198522432062E-03),
                numpy.full(6, 0.1126946125877624E-02),
                numpy.full(6, 0.1747866949407337E-02),
                numpy.full(6, 0.1182818815031657E-02),
                numpy.full(6, 0.1990839294675034E-02),
                numpy.full(6, 0.1900412795035980E-02),
                numpy.full(6, 0.4498365808817451E-02),
                numpy.full(6, 0.3478719460274719E-02),
                numpy.full(6, 0.4102399036723953E-02),
                numpy.full(6, 0.4021761549744162E-02),
                numpy.full(6, 0.6033164660795066E-02),
                numpy.full(6, 0.3946290302129598E-02),
                numpy.full(6, 0.6644044537680268E-02),
                numpy.full(6, 0.8254305856078458E-02),
                numpy.full(6, 0.6496056633406411E-02),
                numpy.full(6, 0.9252778144146602E-02),
                numpy.full(6, 0.9164920726294280E-02),
                numpy.full(6, 0.1156952462809767E-01),
