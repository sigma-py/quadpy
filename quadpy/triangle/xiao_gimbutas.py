...
class XiaoGimbutas(object):
    ...
    def __init__(self, index, symbolic=False):
        ...
        if index == 1:
            self.bary = numpy.concatenate([_s3(symbolic)])
            self.weights = numpy.concatenate([numpy.full(1, 1.0)])
        elif index == 2:
            self.bary = numpy.concatenate([_s21(0.16666666666666666666666666666667)])
