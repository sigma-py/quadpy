...
class PiessensHaegemans(object):
    ...
    def __init__(self, index):
        self.name = "PiessensHaegemans({})".format(index)
        ...
        if index == 1:
            data = {
                ...
                "pmx": [[0.40927359555433144329, 0.57882826011929170546]],
                "pmy": [
                    [0.10648011781560231854, 0.97700090158004246059],
                    [0.45321488105170985638, 0.39364057271848893512],
                ],
            }
        else:
            assert index == 2
            data = {
                ...
                "pmx": [[0.45212398131214854997, 0.49471787965159623409]],
                "pmy": [
                    [0.10243215270991495821, 0.98085697194664054422],
                    [0.45601422352687001122, 0.48311469619727965642],
                ],
            }
