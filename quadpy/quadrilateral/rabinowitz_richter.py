...
"""
from .helpers import concat, symm_r0, symm_s, symm_s_t, zero


class RabinowitzRichter1(object):
    def __init__(self):
        self.degree = 9
...
class RabinowitzRichter2(object):
    def __init__(self):
        self.degree = 11
        self.weights, self.points = concat(
...
class RabinowitzRichter3(object):
    def __init__(self):
        self.degree = 11
        self.weights, self.points = concat(
            symm_r0(
...
class RabinowitzRichter4(object):
    def __init__(self):
        self.degree = 13
        self.weights, self.points = concat(
...
class RabinowitzRichter5(object):
    def __init__(self):
        self.degree = 15
        self.weights, self.points = concat(
            symm_r0(
...
class RabinowitzRichter6(object):
    def __init__(self):
        self.degree = 15
        self.weights, self.points = concat(
            symm_r0(
...
RabinowitzRichter = {
    1: RabinowitzRichter1,
    2: RabinowitzRichter2,
    3: RabinowitzRichter3,
    4: RabinowitzRichter4,
    5: RabinowitzRichter5,
    6: RabinowitzRichter6,
}
