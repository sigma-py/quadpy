    ...
    def __init__(self, index):
        ...
        if index == 1:
            ...
            self.weights = numpy.concatenate([
                numpy.full(4, 0.0480207633507238145627631759775806),
                numpy.full(4, 0.0660713291645505956736350808495464),
                numpy.full(4, 0.0973867773586681641961204397995472),
                numpy.full(4, 0.211736349998948600503931661356261),
                numpy.full(4, 0.225626061728863387403158016208490),
                numpy.full(4, 0.351158718398245437660391625808574),
                ])
            self.points = numpy.concatenate([
                _s4(0.982639223540855472952491497004009,
                    0.698076104549567564776469806174958),
                _s4(0.825775835902963937302274585289940,
                    0.939486382816736907206432362169896),
                _s4(0.188586138718641954600324568182745,
                    0.953539528201532015845004266823976),
                _s4(0.812520548304813100489382581912299,
                    0.315623432915254195985609716402104),
                _s4(0.525320250364547762341631887140024,
                    0.712001913075336306549065895123759),
                _s4(0.0416580719120223682735468045377018,
            ...
            self.degree = 13
            self.weights = numpy.concatenate([
                numpy.full(4, 0.29991838864499131666e-01),
                numpy.full(4, 0.38174421317083669640e-01),
                numpy.full(4, 0.60424923817749980681e-01),
                numpy.full(4, 0.77492738533105339358e-01),
                numpy.full(4, 0.11884466730059560108e+00),
                numpy.full(4, 0.12976355037000271129e+00),
                numpy.full(4, 0.21334158145718938943e+00),
                numpy.full(4, 0.25687074948196783651e+00),
                numpy.full(1, 0.30038211543122536139e+00),
                ])
            self.points = numpy.concatenate([
