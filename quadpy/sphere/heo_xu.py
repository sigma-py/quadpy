    ...
    def __init__(self, index):
        if index == '13':
            ...
            data = [
                ...
                (0.002771951327, _f11(0.663530717023, 0.747173970345)),
                (0.002771951327, _f11(0.560342562719, 0.821357965819)),
            ...
            data = [
                ...
                (0.002496644054, _f1(0.471598691154)),
                (0.002496644054, _f1(0.210272522872)),
                (0.002416930044, _f11(0.590515704894, 0.799927854385)),
                (0.002416930044, _f11(0.555015236112, 0.771746262687)),
            ...
            data = [
                ...
                (0.001611967438, _f1(0.444572576129)),
                (0.002245940979, _f11(0.630713490341, 0.746274388124)),
                (0.002245940979, _f11(0.596705492981, 0.724560936181)),
                (0.002245940979, _f11(0.587046661123, 0.807169311670)),
                (0.002245940979, _f11(0.505464222397, 0.844656624412)),
                (0.002245940979, _f11(0.458746299673, 0.824994538226)),
                (0.002245940979, _f11(0.369539839929, 0.915094022626)),
                (0.001967307858, _f11(0.277639225331, 0.958974697835)),
                (0.001561575961, _f11(0.116956662074, 0.992865475735)),
                ]
        elif index == '39-1':
            self.degree = 39
            data = [
