...
class XiaoGimbutas(object):
    ...
    def __init__(self, index):
        if index == 1:
            ...
            bary = numpy.concatenate([
                _s21(2.194299825497830e-01),
                _s21(4.801379641122150e-01),
                _s111(1.416190159239681e-01, 1.937172436124080e-02),
                ])
            self.weights = numpy.concatenate([
                1.713331241529810e-01 * numpy.ones(3),
                8.073108959303098e-02 * numpy.ones(3),
                4.063455979366066e-02 * numpy.ones(6),
                ])
        elif index == 7:
            bary = numpy.concatenate([
                _s21(4.731956536892511e-01),
                _s21(5.779764005450649e-02),
                _s111(2.593390118657857e-01, 4.697120613008553e-02),
                _s21(2.416636063972474e-01),
                ])
            self.weights = numpy.concatenate([
                5.318083329676046e-02 * numpy.ones(3),
                4.091817039405687e-02 * numpy.ones(3),
                5.575454054069109e-02 * numpy.ones(6),
                1.277252485611338e-01 * numpy.ones(3),
                ])
        elif index == 8:
            bary = numpy.concatenate([
                _s21(1.705693077517603e-01),
                _s21(4.592925882927232e-01),
                _s3(),
                _s21(5.054722831703107e-02),
                _s111(2.631128296346381e-01, 8.394777409957675e-03),
                ])
            self.weights = numpy.concatenate([
                1.032173705347182e-01 * numpy.ones(3),
                9.509163426728463e-02 * numpy.ones(3),
                1.443156076777872e-01 * numpy.ones(1),
                3.245849762319808e-02 * numpy.ones(3),
                2.723031417443500e-02 * numpy.ones(6),
                ])
        elif index == 9:
            bary = numpy.concatenate([
                _s21(4.896825191987376e-01),
                _s3(),
                _s21(1.882035356190328e-01),
                _s111(2.219629891607657e-01, 3.683841205473630e-02),
                _s21(4.370895914929366e-01),
                _s21(4.472951339445275e-02),
                ])
            self.weights = numpy.concatenate([
                3.133470022713907e-02 * numpy.ones(3),
                9.713579628279884e-02 * numpy.ones(1),
                7.964773892721026e-02 * numpy.ones(3),
                4.328353937728938e-02 * numpy.ones(6),
                7.782754100477428e-02 * numpy.ones(3),
                2.557767565869803e-02 * numpy.ones(3),
                ])
        elif index == 10:
            bary = numpy.concatenate([
                _s21(4.951734598011704e-01),
                _s21(1.913941524284135e-02),
                _s111(1.337347551008691e-01, 3.472362048232748e-02),
                _s3(),
                _s111(3.266931362813369e-01, 3.758272734119170e-02),
                _s21(1.844850126852465e-01),
                _s21(4.282348209437189e-01),
                ])
            self.weights = numpy.concatenate([
                9.792590498418303e-03 * numpy.ones(3),
                6.385359230118654e-03 * numpy.ones(3),
                2.896228146325634e-02 * numpy.ones(6),
                8.361487437397393e-02 * numpy.ones(1),
                3.873904908601890e-02 * numpy.ones(6),
                7.863376974637727e-02 * numpy.ones(3),
                7.524732796854398e-02 * numpy.ones(3),
                ])
        elif index == 11:
            bary = numpy.concatenate([
